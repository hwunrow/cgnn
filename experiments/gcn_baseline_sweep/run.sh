#!/bin/bash
# GCN baseline sweep: hospital+case × advan+safegraph × cutoff500+1000 = 8 experiments
...
echo "=========================================="
echo "Submitting GCN Baseline Sweep"
echo "=========================================="
...
for data_source in "${DATA_SOURCES[@]}"; do
    for mobility_source in "${MOBILITY_SOURCES[@]}"; do
        for mobility_cutoff in "${MOBILITY_CUTOFFS[@]}"; do
            VERSION="${data_source}_${mobility_source}_cutoff${mobility_cutoff}"
