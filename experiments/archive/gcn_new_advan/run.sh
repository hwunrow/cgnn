#!/bin/bash
# GCN sweep with new Advan data: hospital+case × advan × cutoff500+1000 = 4 experiments
...
declare -a MOBILITY_SOURCES=("advan")
...
echo "=========================================="
echo "Submitting GCN New Advan Experiments"
echo "=========================================="
...
for data_source in "${DATA_SOURCES[@]}"; do
    for mobility_source in "${MOBILITY_SOURCES[@]}"; do
        for mobility_cutoff in "${MOBILITY_CUTOFFS[@]}"; do
            VERSION="${data_source}_new_${mobility_source}_cutoff${mobility_cutoff}"
            ...
            HYDRA_PARAMS="data=${DATE_CONFIG} model=${MODEL_CONFIG} data.version=${VERSION} data.mobility_cutoff=${mobility_cutoff}"
