# Rerun Explainer — Hospital Data (2026-03-14)

## Experiment

Re-run GNNExplainer on a pre-trained CDCRNN checkpoint using hospital
admissions data (`hospital_advan_plus_full_cdcrnn`) since this original experiment
...
`plots/hospital_advan_plus_cdcrnn_h1_lr1e-05_hs16_rerun_explainer_lr0.01_epochs_{N_EPOCHS}/`
...
**SLURM logs**: `experiments/20260314_rerun_explainer_hospital_data/logs/`
